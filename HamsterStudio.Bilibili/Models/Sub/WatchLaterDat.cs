...
namespace HamsterStudio.Bilibili.Models.Sub
{
    public class WatchLaterDat
    {
        ...
        public string ShortLinkV2 { get; set; } = string.Empty;
        ...
        public string PubLocation { get; set; } = string.Empty;

        /// <summary>
        /// 
        /// </summary>
        [JsonPropertyName("cover43")]
        public string Cover43 { get; set; } = string.Empty;
        ...
        public string ViewText1 { get; set; } = string.Empty;
        ...
        public string PgcLabel { get; set; } = string.Empty;
